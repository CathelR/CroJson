...
static bool IsQuoteValid(short, short, int*);
static bool IsCommaValid(short, short, int*);
static bool IsColonValid(short, short, int*);
static bool IsCurlyOpenValid(short, short, int*);
static bool IsCurlyCloseValid(short, short, int*);
static bool IsSquareOpenValid(short, short, int*);
static bool IsSquareCloseValid(short, short, int*);
static bool IsGenericCharValid(short, short, int*);
